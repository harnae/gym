...
//	
//	void SecurityConfig(UserService userService) {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
			.authorizeHttpRequests((authz) -> authz
				.requestMatchers("/", "/templates/css/**","/login", "/newuser","/signup","/loginProc").permitAll()
				.requestMatchers("/userinfo").hasRole("USER")
